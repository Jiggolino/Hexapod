SamacSys ECAD Model
974258/1803662/2.50/10/3/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SOP50P488X110-10N" (originalName "SOP50P488X110-10N")
		(multiLayer
	...
	(symbolDef "SP4065-08ATG" (originalName "SP4065-08ATG")
	...
	(compDef "SP4065-08ATG" (originalName "SP4065-08ATG") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "I/O_4") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "NC") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "I/O_8") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "I/O_7") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "I/O_6") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "I/O_5") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "GND") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SP4065-08ATG"))
		(attachedPattern (patternNum 1) (patternName "SOP50P488X110-10N")
			(numPads 10)
			(padPinMap
		...
		(attr "Mouser Part Number" "576-SP4065-08ATG")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Littelfuse/SP4065-08ATG?qs=0Dbrz4iFQy%2FklE79eCp2zA%3D%3D")
		(attr "Manufacturer_Name" "LITTELFUSE")
		(attr "Manufacturer_Part_Number" "SP4065-08ATG")
		(attr "Description" "LITTELFUSE - SP4065-08ATG - DIODE, ESD PROTECTION, 3.3V, MSOP")
		(attr "Datasheet Link" "https://componentsearchengine.com/Datasheets/2/SP4065-08ATG.pdf")
		(attr "Height" "1.1 mm")
	)
