...
(library Library_1
	...
	(symbolDef "B340A-13-F" (originalName "B340A-13-F")
	...
	(compDef "B340A-13-F" (originalName "B340A-13-F") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "B340A-13-F"))
		...
		(attr "Mouser Part Number" "621-B340A-F")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/B340A-13-F?qs=aLaTXeBcTP9fj%2FYKVo6Q1A%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "B340A-13-F")
		(attr "Description" "Schottky Diode 3A 40V 0.5Vf SMA Diodes Inc B340A-13-F, SMT Schottky Diode, 40V 3A, 2-Pin DO-214AC")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-305/73551.pdf")
		(attr "<Component Height>" "2.4")
		(attr "<STEP Filename>" "B340A-13-F.stp")
		(attr "<STEP Offsets>" "X=-2.01;Y=4.11;Z=-1.62")
